  ...
  <>
    <section className="body-bg pt-5">
      <div className="bg-div text-center my-3">
        ...
        <div className="button-div">
          ...
          <button type="submit" className="button2">Learn more</button>
        </div>
    ...
    <section>
      <div className="hope_div text-center">
        ...
        <p className="hope_text">
          Don’t let depression keep you down.
          Let HopeWave’s Speak Hope AI help you navigate the storm with
          <br />
          {' '}
          powerful AI-assisted conversations. Let’s ride the wave of hope together!
        </p>
        <button type="submit" className="hope_btn">Get started Now</button>
      </div>
    </section>
